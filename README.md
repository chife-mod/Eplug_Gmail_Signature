...
| `signature-2-david.html` | **Type 2 / David Orgel** — вариант «только награды» по просьбе клиента: логотип Energy Plus + Recognition & Awards, **без VUE и без LinkedIn**, титул не задан. Офис+мобильный, адрес. Карта 600×238. |
